...
const About = () => {
    ...
    <div className="container px-5 py-24 mx-auto">
        ...
        <button onClick={()=>navigate("/signup")} className="flex mx-auto mt-16 text-white bg-primary border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg">Sign up</button>
    </div>
    </section>
    )
